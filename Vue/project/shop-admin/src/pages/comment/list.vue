<template>
  <el-card shadow="never" class="border-0">
    ...
    <el-table default-expand-all :data="tableData" stripe style="width: 100%" v-loading="loading">
      ...
      <el-table-column label="ID" width="170" align="center" prop="id" />
      ...
      <el-table-column label="评价时间" width="400" align="center" prop="review_time" />
      <el-table-column label="状态" class="flex-1">
        <template #default="{ row }">
