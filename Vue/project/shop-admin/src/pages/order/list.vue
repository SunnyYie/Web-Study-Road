<template>
  <div>
    <el-tabs v-model="searchForm.tab" @tab-change="searchFunc">
    ...
    <el-card shadow="never" class="border-0">
      ...
      <el-table ref="multipleTableRef" @selection-change="handleSelectionChange" :data="tableData" stripe style="width: 100%" v-loading="loading">
        ...
        <el-table-column label="实际付款" width="300" prop="total_price" align="center" />
        ...
        <el-table-column label="交易状态" width="300" align="center">
          <template #default="{ row }">
            <div>
              付款状态：
...
const { handleSelectionChange, multipleTableRef, handleMultiDelete, searchForm, resetSearchForm, tableData, loading, currentPage, total, limit, getData } = useInitTable({
  searchForm: {
    no: '',
    tab: 'all',
    starttime: '',
